...
function composeURL() {
    var progression = ['Dm7', 'G7', 'Cmaj7', 'Cmaj7'];
    var tempo = 120;
    var drumData = beat16(progression.length);
    var gitData = composeGuitar(progression);
    var viData = composeViola(progression, chordPitches);
